...
es: {
    ...
    dashboard: {
      ...
      idLabel: "ID del grupo",
      objectIdLabel: "Object ID",
      inviteCodeLabel: "Código de invitación",
      createdByLabel: "Administrador",
      myStatusLabel: "Mi estado",
      participantsEmpty: "No hay participantes aún.",
      transactionsTitle: "Transacciones",
      transactionsRecords: "registros",
      transactionsEmpty: "Aún no hay transacciones registradas.",
      transactionExternal: "Pago externo disponible",
      turnLabel: "Turno",
      adminLabel: "Admin",
      memberLabel: "Miembro",
      status: "Estado",
      ...
      startDialog: {
        title: "¿Iniciar la tanda?",
        warning: "Acción irreversible",
        body: "Al iniciar la tanda se desplegará el contrato inteligente en la blockchain de Sui. Esta acción no se puede deshacer.",
        confirm: "Sí, iniciar tanda",
        cancel: "Cancelar",
      },
      deploy: {
        building: "Construyendo transacción...",
        requestingProof: "Solicitando prueba ZK...",
        sponsoring: "Patrocinando transacción...",
        signing: "Firmando transacción...",
        executing: "Ejecutando en blockchain...",
        success: "¡Tanda desplegada exitosamente!",
        errorBuilding: "Error al construir la transacción",
        errorProof: "Error al obtener la prueba ZK",
        errorSponsor: "Error al patrocinar la transacción",
        errorSigning: "Error al firmar la transacción",
        errorExecuting: "Error al ejecutar la transacción",
        errorMissingSession: "Sesión de zkLogin no encontrada. Inicia sesión nuevamente.",
        errorMissingAddresses: "Faltan direcciones de los miembros. Todos deben haber completado su registro.",
      },
    },
    groups: {
      create: {
  ...
  en: {
    ...
    dashboard: {
      ...
      transactionExternal: "External payment available",
      turnLabel: "Turn",
      adminLabel: "Admin",
      memberLabel: "Member",
      status: "Status",
      ...
      startDialog: {
        title: "Start the tanda?",
        warning: "Irreversible action",
        body: "Starting the tanda will deploy the smart contract on the Sui blockchain. This action cannot be undone.",
        confirm: "Yes, start tanda",
        cancel: "Cancel",
      },
      deploy: {
        building: "Building transaction...",
        requestingProof: "Requesting ZK proof...",
        sponsoring: "Sponsoring transaction...",
        signing: "Signing transaction...",
        executing: "Executing on blockchain...",
        success: "Tanda deployed successfully!",
        errorBuilding: "Error building the transaction",
        errorProof: "Error obtaining the ZK proof",
        errorSponsor: "Error sponsoring the transaction",
        errorSigning: "Error signing the transaction",
        errorExecuting: "Error executing the transaction",
        errorMissingSession: "zkLogin session not found. Please sign in again.",
        errorMissingAddresses: "Member addresses are missing. All participants must complete registration.",
      },
    },
    groups: {
      create: {
